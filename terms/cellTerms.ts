...
export const cellTerms: TermObject = {
  ...
  "organelles" : "subcellular structures that have one or more specific jobs to perform in the cell",
  ...
  "peroxisomes" : "organelles that detoxify waste products",
...
export const membraneTerms: TermObject = {
  ...
  "ECM" : "meshwork of fibrous proteins embedded in watery, gel-like substance (short form)",
  ...
  "tight junctions" : "impermeable junctions that seal off the passageway between the two cells (incl. 'junctions')",
  "gap junctions" : "communicating junctions",
  "desmosomes tight gap" : "3 types of specialised cell junctions",
  "spot rivets" : "what desmosomes act like",
  "extreme mechanical pressure" : "desmosomes help cells stay together through ____",
...
export const passiveMembraneTransport = {
  ...
  "gradient" : "what provides the force in diffusion (1 word)",
  "net diffusion" : "the diffusion from area A to area B minus diffusion from area B to area A",
  "Ficks" : "Whose law of diffusion?",
  "magnitude, surface area, lipid solubility" : "3 factors that increase the rate of net diffusion",
  "molecular weight, distance" : "2 factors that decrease the rate of net diffusion",
  ...
  "red blood cells" : "type of cells with an extremely thin plasma membrane",
  ...
  "osmotic pressure" : "'pulling' pressure that is measure of tendency for water to move into solution due to concentration of non-penetrating solutes & water (incl. 'pressure')",
  "hydrostatic pressure" : "fluid pressure - caused from rise in volume (incl. 'pressure')",
...
export const passiveMembraneTransport2 = {
  "pull" : "is osmosis a push or a pull force",
  "push" : "is hydrostatic pressure a push or a pull force",
  "change" : "if substance is non-penetrating, does volume change or not change",
  "not change" : "if substance is penetrating, does volume change or not change",
  "equal concentration hydrostatic pressure" : "2 ways solutions can reach equilibrium (4 words)",
  "oxygen" : "a common penetrating solute that won't affect volume",
  "ions" : "common non-penetrating solutes",
  "tonicity" : "effect the solution has on cell volume",
  "nonpenetrating" : "which solutes does tonicity look at",
  "all" : "which solutes does osmolarity look at",
  "isotonic" : "result in constant cell volume",
  "hypotonic" : "solution that tends to swell the cell",
  "hypertonic" : "solution that tends to shrink the cell",
  "osmolarity" : "measure of solute concentration per unit volume of solvent",
  "molarity" : "concentration of compaound as a whole",
  "ionic compounds" : "which type of molecules can make osmolarity more than molarity",
  "hydrostatic pressure" : "what stops cell from continuing to swell if not at equal concentration",
  "shrink" : "what will a cell do in a hypertonic solution",
  "swell" : "what will a cell do in a hypotonic solution",
  "hypertonic solution" : "type of solution if inside of cell is 300mOsm/L and outside is 400mOsm/L (incl. solution)",
  "hypotonic solution" : "type of solution if inside of cell is 300mOsm/L and outside is 200mOsm/L (incl. solution)",
  "100" : "if NaCl concentration is 100 mmol/L, what is the molarity of the solution",
  "200" : "if NaCl concentration is 100 mmol/L, what is the osmolarity of the solution",
  "300" : "if NaCl concentration is 200 mmol/L and urea is 100 mmol/L, what is the molarity of the solution",
  "500" : "if NaCl concentration is 200 mmol/L and urea is 100 mmol/L, what is the osmolarity of the solution",
  "400" : "if NaCl concentration is 200 mmol/L and urea is 100 mmol/L, what is the tonicity of the solution",
  "carrier-mediated" : "what type of transport can be active or passive, and requires a protein that spans the plasma membrane",
  "glucose amino acids" : "2 common types of molecules that use carrier-mediated tranport",
  "specificity saturation competition" : "3 important characteristics that rule carrier-mediated transport",
  "flip flop" : "fun term that describes how the binding sites on carrier-mediated transport proteins work",
  "facilitated diffusion" : "process when a carrier molecule facilitates the transfer of a substance across the membrane from high to low concentration",
  "passive" : "is facilitated diffusion active or passive",
  "saturate" : "binding sites on facilitated diffusion proteins can ___, which affects the rate",
}

export const activeTransport = {
  "uses" : "carrier-mediated transport ___ energy",
  "affinity" : "what term describes how strong the binding potential of a molecule is to the binding site",
  "against" : "does carrier-mediated active transport carry molecules along or against the concentration gradient",
  "more" : "is there greater affinity with more or less sides",
  "circle" : "what shape has the greatest affinity",
  "passive" : "after carrier molecule has flipped, is the flop active or passive",
  "ATP" : "what is used to move substance against concentration gradient in primary active transport",
  "primary secondary" : "what are the two types of active transport",
  "directly" : "is energy directly or indirectly used in primary active transport",
  "indirectly" : "is energy directly or indirectly used in secondary active transport",
  "low" : "what side of the concentration gradient (low or high) has enzyme binding sites with greater affinity during primary active tranport",
  "pump" : "what do we call carriers in active transport",
  "ATPase" : "what is the enzyme that breaks down ATP to release phosphate group",
  "uses energy free" : "the flip ___ ___, but the flop is ____",
  "single two" : "what are the two types of active transport carriers (check hint for wording once correct)",
  "nerve cell membrane" : "where in body are there about 1 million Na+-K+ pumps",
  "200" : "how many million ions per second can nerve cell membrane sodium potassion ATPase pumps transport",
  "secondary active transport" : "Na+ & K+ concentration gradients across plasma membrane serve as energy source for what process in Na+-K+ pump",
  "sodium" : "what ion is more concentrated outside of nerve cells",
  "potassium" : "what ion is more concentrated inside of nerve cells",
  "electric potential" : "the sodium-potassium pump creates this inside the body",
  "3" : "how many binding pockets are there for sodium in the pump",
  "2" : "how many binding pockets are there for potassium",
  "outside" : "sodium is transported towards ____ of cell",
  "inside" : "potassium is transported towards ___ of cell",
  "actively passively" : "sodium is transported ___ and potassium is transported ____",
  "no" : "is ATP required for secondary active transport pumps",
  "second" : "is energy in secondary active transport 'first' or 'second' hand",
  "symport" : "secondary active transport type that moves molecules in same direction (shorter word)",
  "antiport" : "secondary active transport type that moves molecues in opposite directions (shorter word)",
  "symport antiport" : "two types of secondary active transport (shorter words)",
  "cotransport counter-transport" : "two types of secondary active transport (longer words)",
  "glucose intestine kidney" : "example of secondary active transport can be seen in movement of _____ in ____ and _____ cells",
  "symport two" : "secondary active transport of glucose in luminal border is considerd ____ because it moves ____ molecule(s)",
  "Na+ concentration gradient" : "what powers the cotransport carrier when glucose is being transported out of lumen of small intenstine",
  "Na+-K+ pump" : "what establishes gradient that powers active transport of glucose out of lumen of small intestine",
  "basolateral border" : "where does Na+ get actively pumped out of epithelial cell to keep concentration gradient of cell that powers the removal of glucose from the intestinal lumen",
  "primary active transport" : "what type of transport happens to remove Na+ from an epithelial cell in the intestine (incl. 'transport')",
  "facilitated diffusion" : "what process makes glucose leave epithelial cell and into the blood",
  "passive glucose carrier" : "what mediates the diffusion of glucose out of intestinal epithelial cell",
  "K+" : "what gets actively transported into epithelial cell as part of the common pump",
  "none" : "what type of influence does K+ have on secondary active transport of glucose out of intestinal lumen"
}